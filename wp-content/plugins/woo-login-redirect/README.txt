...
Contributors: nazmulhassann20,wpdoctors
...
* Install this plugin  
* After installing, Please navigate to wp-admin->WooCommerce->Settings->Login Redirect. In this tab you will get both options to redirect user after login and registration.
...
Q: Does this plugin support all themes?
A: Yes.
...
= v2.1 (20 September, 2018) =
* [New] Added login redirect options for Subscriber and Editor