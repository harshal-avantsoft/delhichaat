...
class Woo_Login_Redirect_Settings {
    ...
    public function get_settings() {
        $settings = array(
            ...
            array(
                'title'    => __( 'Subscriber Login Redirect', 'woocommerce' ),
                'desc'     => __( 'Redirect subscriber after login', 'woocommerce' ),
                'id'       => 'subscriber_login_redirect_page_id',
                'type'     => 'single_select_page',
                'default'  => '',
                'class'    => 'wc-enhanced-select',
                'css'      => 'min-width:300px;',
            ...
            array(
                ...
                'desc'     => __( 'Redirect shop manager after login', 'woocommerce' ),
            ...
            array(
                'title'    => __( 'Editor Login Redirect', 'woocommerce' ),
                'desc'     => __( 'Redirect editor after login', 'woocommerce' ),
                'id'       => 'editor_login_redirect_page_id',
                'type'     => 'single_select_page',
                'default'  => '',
                'class'    => 'wc-enhanced-select',
                'css'      => 'min-width:300px;',
