...
<?php //screen_icon();
add_thickbox();  ?>
<h2><?php _e( 'Edit Themes', 'theme-editor' ); ?> <a href="http://themeeditor.webdesi9.com/product/theme-editor/" class="button button-primary" target="_blank"><?php _e('BUY PRO', 'theme-editor');?> </a></h2>
<?php 
$theme = wp_get_theme();	
...
if ( is_object( $data['wp_theme'] ) && $data['wp_theme']->name == $theme->name ): ?>
   ...
   <div class="fileedit-sub">
		...
		<div class="alignright">
            ...
            <div class="theme_action_section"><a href="#TB_inline?width=600&height=300&inlineId=theme_upload" class="thickbox button button-primary" title="Upload Files and Folders"><?php _e( 'Upload', 'theme-editor' ); ?></a> <a href="#TB_inline?width=600&height=550&inlineId=create_folder" class="thickbox button button-primary" title="Create Folder and File"><?php _e( 'Create', 'theme-editor' ); ?></a> <a href="#TB_inline?width=600&height=550&inlineId=remove_folder" class="thickbox button button-primary" title="Remove Folder and File"><?php _e( 'Remove ', 'theme-editor' ); ?></a></div>
		</div>
		<br class="clear" />
	</div>
