...
<h1><span class="dashicons dashicons-admin-settings"></span> <?php _e('Settings', 'theme-editor');?></h1>
...
<p class="submit te_submit_button"><input name="submit_mk_te_settings" id="submit" class="button button-primary" value="Save Changes" type="submit"></p>
</form>
</div>