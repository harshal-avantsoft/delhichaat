...
class RM_Email_Service
{
    ...
    public static function notify_admin_to_activate_user($params)
    {
        ...
        $form->load_from_db($params->form_id);        
        $form_options= $form->form_options;        
        $subject = (isset($form_options->form_activate_user_notification_sub))?$form_options->form_activate_user_notification_sub:RM_UI_Strings::get('MAIL_ACTIVATE_USER_DEF_SUB');
        /*
