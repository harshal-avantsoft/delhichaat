...
class RM_Front_Controller {
    ...
    public function set_otp($model, $service, $request, $params) {
        ...
        if(in_array($sanitized_user_ip, $blocked_ips)){
            echo '{"error":true,"show":"#rm_otp_enter_otp","hide":"#rm_noelement","reload":false,"msg":"'.__('Your IP has been banned by the Admin due to repeated failed login attempts.','custom-registration-form-builder-with-submission-manager').'"}';exit;
        }
