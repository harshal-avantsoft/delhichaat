...
<!-- Joyride Magic begins -->
    <ol id="rm-form-sett-dashboard-joytips" style="display:none">
        ...
        <li><h5><?php _e('Welcome to the Form Dashboard!','custom-registration-form-builder-with-submission-manager'); ?></h5>
            <br/>
        ...
        <li><?php _e("Remember - each form will have its own dashboard; accessible by clicking DASHBOARD on its form card. That's how you reached here, right? But once you're here, you do not need to go back to open another form's dashboard. You can just...",'custom-registration-form-builder-with-submission-manager'); ?></li>
        ...
        <li><h5><?php _e("We hope you liked what you have seen so far! Let's move on to the two Sidebars.",'custom-registration-form-builder-with-submission-manager'); ?></h5></li>
