...
<div class="rmagic rmbasic">
    ...
    <ol id="rm-form-man-joytips" style="display:none">
        ...
        <li><h3>
                <?php _e('Forms As Cards', 'custom-registration-form-builder-with-submission-manager'); ?>
            </h3>
...
?>
    ...
    <div id="rm_form_publish_popup" class="rm-modal-view" style="display: none;">
        ...
        <!-- Login introductory Popup -->
        <?php 
            $g_opt= new  RM_Options(); 
            $disable_login_popup= $g_opt->get_value_of('disable_login_popup');
            $upgraded= get_option('rm_option_upgraded', 0);
            if(empty($disable_login_popup) &&  !empty($upgraded)){
        ?>
        <div id="rm_login-introductory-popup" class="rm-modal-view">
            <div class="rm-modal-overlay rm_login-popup-overlay"></div>

            <div class="rm-modal-wrap rm_login-popup">

                <div class="rm-modal-container">
                    <?php require RM_ADMIN_DIR . 'views/template_rm_login-introductory-popup.php'; ?>
                </div>
            </div>
        </div>
        <?php } ?>
        <!-- End: Login introductory Popup -->
