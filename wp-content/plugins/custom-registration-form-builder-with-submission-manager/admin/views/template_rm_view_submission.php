                ...
                <div class="rm-submission-label rm-custom_status-wrap">
                    ...
                    <div class="rm-submission-value rm-custom-status-lr">
                        ...
                        <div class="rm-submission-value rm-add-custom-status-value" style="display:none">
                           ...
                           <span class="rm_buy_pro_inline"><?php printf(__('To unlock Custom Statuses (and many more), please upgrade <a href="%s" target="blank">Click here</a>','custom-registration-form-builder-with-submission-manager'),'http://registrationmagic.com/?download_id=317&amp;edd_action=add_to_cart'); ?> </span>
                           <div class="rm-custom-status-ext-link"><a href="https://registrationmagic.com/custom-status-guide-tag-label-user-data-execute-multiple-actions" target="blank"><?php _e('Learn how to boost your productivity with Custom Statuses!','custom-registration-form-builder-with-submission-manager') ?></a></div>
                            </div>
                    </div>
                </div>
