...
wp_localize_script('rm-login-form-presentation','pr_data',array('upload_btn_title'=>__('Choose Image','custom-registration-form-builder-with-submission-manager'),'older_ie'=>__('You are using older version of IE. Please update IE to latest version','custom-registration-form-builder-with-submission-manager')));
            ...
            <div class="rm_style_container" id="rm_style_container"  style='<?php echo $design['style_form']; ?>'>
                ...
                <?php foreach ($fields as $key => $field): $loop_index++; ?>
                        <div class="rmrow rm_edit_form_ui">
                            <div class="rmfield" style="<?php echo $design['style_label']; ?>" id="rm_field_label"><?php echo $field['field_label']; ?></div>
                            <div class="rminput">
                                <input class="rm_field_focus_bg rm_field_focus_text" style='<?php echo $design['style_textfield']; ?>' type="text"  placeholder="<?php echo $field['placeholder']; ?>" id="rm_textfield" />
                            </div>
                        <?php if ($loop_index == 1) : ?>
                ...
                <div class="rm_btn_selector">
                    <input class="rm_btn_focus" type="button" style='<?php echo $design['style_btnfield']; ?>' value="<?php echo $submit_btn_label; ?>" id="rm_btnfield"/>
