            ...
            <tbody>
                ...
                if(isset($data->login_logs)){
                    if (!empty($data->login_logs) && (is_array($data->login_logs) || is_object($data->login_logs))){
                            ...
                            <tr class="rm-login-result <?php echo ($login_log->status==1)?'rm-login-success':'rm-login-failed'; ?>">
                                ...
                                <td>
                                    <div class="rm-login-form-user">
                                        <a href="#">
                                            <?php echo get_avatar($login_log->email); ?>
                                        </a>
                        ...
                        echo '<div class="rmnotice">'.sprintf(__('Not enough logic activity recorded yet to generate analytics. This can be because you have recently installed or upgraded to RegistrationMagic 4.0. Please comeback after sometime to check the stats. You can find details of all login activity on your site here. <a target="_blank" href="%s">More Info</a>', 'custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/wordpress-user-login-plugin-guide/#login-analytics').'</div>';
                    }
                }
                ?>
            </tbody>
