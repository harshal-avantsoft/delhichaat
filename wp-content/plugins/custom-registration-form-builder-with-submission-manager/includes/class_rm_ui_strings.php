    ...
    public static function get($identifier) {
        ...
        switch ($identifier) {
            ...
            case 'MSG_BUY_PRO_INLINE':
                return sprintf(__('<span class="rm_buy_pro_inline">To unlock this feature (and many more), please upgrade <a href="%s" target="blank">Click here</a></span>', 'custom-registration-form-builder-with-submission-manager'),'http://registrationmagic.com/?download_id=317&amp;edd_action=add_to_cart');

            case 'MSG_BUY_PRO_INLINE_ATT':
                return sprintf(__('<span class="rm_buy_pro_inline">View and Download <b>form attachments</b> at a single place by upgrading <a href="%s" target="blank">Click here</a></span>', 'custom-registration-form-builder-with-submission-manager'),'http://registrationmagic.com/?download_id=317&amp;edd_action=add_to_cart');

            case 'MSG_BUY_PRO_BOTH_INLINE':
                return sprintf(__('<span class="rm_buy_pro_inline">To unlock this feature (and many more), please upgrade <a href="%s" target="blank">Click here</a></span>', 'custom-registration-form-builder-with-submission-manager'),'https://registrationmagic.com/comparison/');
            ...
            case 'GLOBAL_SETTINGS_EXTERNAL_INTEGRATIONS_EXCERPT':
                return __('Constant Contact, MailChimp (more coming soon!)', 'custom-registration-form-builder-with-submission-manager');
