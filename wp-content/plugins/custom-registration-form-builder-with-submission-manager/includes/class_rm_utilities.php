...
class RM_Utilities {
    ...
    public static function after_login_redirect($user) {
        ...
        else 
        {
            ...
            $redirect_to = home_url("?p=" . $redirect_to);
        }
...
// format date string
    ...
    public static function setup_login_form_options(){
        ...
        if($count==0){
            RM_DBManager::insert_row('LOGIN', array('m_key'=>'recovery','value'=>'{"en_pwd_recovery":1,"recovery_link_text":"Lost your password?"}'), array('%s','%s'));
        }
  ...
  public static function deactivate_rm_user(){
      ...
      $id= $_REQUEST['user_id'];
      $result = update_user_meta($id, 'rm_user_status', '1');
      echo ($result)?'success':'fail';die;
  }
  ...
  public static function activate_rm_user(){
      ...
      $id= $_REQUEST['user_id'];
      $result = update_user_meta($id, 'rm_user_status', '0');
      echo ($result)?'success':'fail';die;
  }
