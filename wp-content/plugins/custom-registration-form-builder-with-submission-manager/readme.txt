...
RegistrationMagic is a powerful WordPress user registration plugin that gives you TOTAL CONTROL of user registrations on your website. You can create different forms for user registrations, each with different pre-defined fields. You can also set up payments for paid user registrations. A Front-End user registration area allows your users to login, reset the password, check transactions, download submissions, etc. 
...
There’s also a full-fledged User Management module integrated with RegistrationMagic. It goes a step ahead of default WordPress User manager by connecting user registration and payment activities with individual user accounts. User Manager is the central hub of RegistrationMagic’s user management system which important information about each user within individual user pages. User management offers enhanced options like suspending and re-activating users.
...
Running a WooCommerce store? WooCommerce user registration is another area where RegistrationMagic comes in handy. We understand, limited registration options in WooCommerce can tie you down. RegistrationMagic can help you improve WooCommerce user registration experience by allowing you to add custom fields to checkout registration form. User Manager can display WooCommerce revenue, addresses and downloads information.

With RegistrationMagic you can build anything from simple to complex registration approval system. Powerful Custom Status offers an option to create multi-step registration approval process. Automations can be used too for automated registration approval mechanism. These features allow you to use RegistrationMagic for industry specific registration systems. For example, a WordPress event registration form. If you are registering with limited seats, the Limits feature can help you build WordPress event registration form which has both a booking time window and option to limit the no of bookings. You can also generate token numbers for every booking for such event registration forms.

Another example would be to use it as WordPress course registration plugin. The Custom Status system allows combining multiple actions in a single click. (Just like your very own macros!) This enables you to move submissions through a vetting process. Every action can prompt user to fulfill certain requirements. With advance Inbox filters and saved searches, It's a cinch to sort and mark submissions. Failed registration attempts can be routed through different registration setup.  

That being said, RegistrationMagic is an equally powerful contact form system. Intelligent contact forms are one of its many unique features build upon real world case scenarios. Since registration and contact forms are neatly displayed inside a single All Forms section, you get a single place to manage all your user submissions and workflows.
