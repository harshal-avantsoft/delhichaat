...
class rm_paypal_class {
	...
	public function submit_paypal_post() {
		...
		echo "<body>\n";
		echo "<center><h2>".__('Please wait, your order is being processed. You will be redirect to PayPal website.','custom-registration-form-builder-with-submission-manager')."</h2></center>\n";
